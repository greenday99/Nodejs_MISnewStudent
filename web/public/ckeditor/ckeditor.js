...
(function() {
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
        ...
        return {
            ...
            on: function(b, d, g, l, k) {
                function q(a, f, y, k) { a = { name: b, sender: this, editor: a, data: f, listenerData: l, stop: y, cancel: k, removeListener: w };
                    return !1 === d.call(g, a) ? !1 : a.data }

                function w() { y.removeListener(b, d) }
                var f = a.call(this, b);
                if (0 > f.getListenerIndex(d)) { f = f.listeners;
                    ...
                    for (var A = f.length - 1; 0 <= A; A--)
                        if (f[A].priority <= k) return f.splice(A + 1, 0, q), { removeListener: w };
                    f.unshift(q) }
            ...
            copyAttributes: function(a, b) {
                ...
                for (var f = 0; f < c.length; f++) {
                    ...
                    if (!(e in b))
                        ...
                        else if (!CKEDITOR.env.ie || this.hasAttribute(e)) t = this.getAttribute(e), null === t && (t = d.nodeValue), a.setAttribute(e, t) } "" !== this.$.style.cssText && (a.$.style.cssText = this.$.style.cssText) },
        ...
        function d(a, b, c, d, e) {
            ...
            if (h && m.type == CKEDITOR.NODE_TEXT && n.equals(m)) n = a.document.createText(n.substring(z, B)), c.append(n);
                ...
                for (N = J; N <= L; N++)
                    ...
                    else { N != L || c.equals(v[N]) && L < F ? b && (ba = K.append(c.clone(0, e))) : C ? p(c, K, !1, w) : Q && K.append(a.document.createText(c.substring(0, B)));
                        if (N > fa)
                            for (; V;) V = p(V, K, !0);
                        K = ba }
                h || l()
            ...
            enlarge: function(a, b) {
                ...
                switch (a) {
                                        ...
                                        if (z && CKEDITOR.dtd.$removeEmpty[n.getName()]) {
                                            ...
                                            if (d.test(E)) n = null;
                                                ...
                                                for (var C = n.$.getElementsByTagName("*"), H = 0, w; w =
                                                    C[H++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[w.nodeName.toLowerCase()]) { n = null;
                                                        break }
                                            n && (B = !!E.length)
                                        } else n = null;
                                    B && (z ? m ? k = h : h && this.setStartBefore(h) : z = !0);
                                    if (n) { B = n.getPrevious();
                                        if (!h && !B) { h = n;
                                            n = null;
                                            break }
                                        n = B } else h = null
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var q, Q, v = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null),
                            I = null,
                            J = function(a) {
                                if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable"))
                                    if (I) {
                                        if (I.equals(a)) { I = null;
                                            return } } else I = a;
                                else if (I) return;
                                var b = v(a);
                                b || (q = a);
            ...
            getNextParagraph: function(a) {
                ...
                for (this._.nextNode = null; x;) {
                    ...
                    if (r) x.type == CKEDITOR.NODE_TEXT && e.test(x.getText()) && (r = 0);
                        ...
                        var n = x.getName();
                        if (CKEDITOR.dtd.$block[n] && "false" == x.getAttribute("contenteditable")) { d = x;
                            b(this, a, d);
                            break } else if (x.isBlockBoundary(this.forceBrBreak && !u && { br: 1 })) {
                            if ("br" == n) r = 1;
                            else if (!l && !x.getChildCount() && "hr" != n) { d = x;
                                A = x.equals(p);
                                break }
                            l && (l.setEndAt(x, CKEDITOR.POSITION_BEFORE_START), "br" != n && (this._.nextNode = x));
                            G = 1 } else {
                            if (x.getFirst()) { l || (l = this.range.clone(), l.setStartAt(x, CKEDITOR.POSITION_BEFORE_START));
                                x = x.getFirst();
                                continue }
                            r = 1 }
                    }
                    ...
                    A = (!G || r) && x.equals(p);
                    if (l && !G)
                        for (; !x.getNext(k) && !A;) { n = x.getParent();
                            if (n.isBlockBoundary(this.forceBrBreak && !u && { br: 1 })) { G = 1;
                                r = 0;
                                A || n.equals(p);
    ...
    (function() {
            ...
            if (h = a.requiredClasses)
                for (n = b.classes, c = 0; c < h.length; ++c)
                    if (d = h[c], "string" == typeof d) {
                        if (-1 == CKEDITOR.tools.indexOf(n, d)) return !1 } else if (!CKEDITOR.tools.checkIfAnyArrayItemMatches(n, d)) return !1;
        ...
        function f(a) {
            var b, c, d, h, n = {},
                e = 1;
            for (a = R(a); b = a.match(I);)(c = b[2]) ? (d = y(c, "styles"), h = y(c, "attrs"), c = y(c, "classes")) : d = h = c = null, n["$" + e++] = { elements: b[1], classes: c, styles: d, attributes: h }, a = a.slice(b[0].length);
            return n }
        ...
        function t(a, b, h, e) {
            ...
            if (e.doFilter) {
                ...
                if (!a.allStyles || a.hadInvalidStyle) {
                    ...
                    K.length && (g.style = K.sort().join("; ")) } else J && (g.style = J);
                if (!a.allClasses ||
                    a.hadInvalidClass) {
                    for (C = 0; C < r.length; ++C)(a.allClasses || f[r[C]]) && E.push(r[C]);
                    E.length && (g["class"] = E.sort().join(" "));
                    z && E.length < z.split(/\s+/).length && (v = !0) } else z && (g["class"] = z);v && (m = 1);
        ...
        function h(a, b, c) {
            var d = a.name;
            if (C.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(u()) : (a.parent && c.push({ check: "it", el: a.parent }), a.remove());
        ...
        function n(a, b, c) {
            ...
            for (d = 0; d < c.length; ++d)
                if (h = c[d], !(h.check && !a.check(h.check, !1) || h.left && !h.left(b))) { h.right(b, K);
                    break } }
            ...
            for (n in d)
                if ("class" == n)
                    for (c = d[n].split(/\s+/), m = a.classes.join("|"); f = c.pop();) {
                        if (-1 == m.indexOf(f)) return !1 } else if (a.attributes[n] != d[n]) return !1;
            for (e in h)
                if (a.styles[e] !=
                    h[e]) return !1;
            return !0
        ...
        CKEDITOR.filter.prototype = {
                ...
                if (!this.disabled && a) {
                    ...
                    for (h = 0; h < a.length; ++h) {
                        ...
                        for (e = 0; e < b.length; ++e) m = b[e], "string" == typeof m ? (m = m.split(/\s*:\s*/), f = m[0], g = null, r = m[1]) : (f = m.check, g = m.left, r = m.right), n || (n = m, n = n.element ? n.element : f ? f.match(/^([a-z0-9]+)/i)[0] :
                            n.left.getDefinition().element), g instanceof CKEDITOR.style && (g = B(g)), c.push({ check: f == n ? null : f, left: g, right: "string" == typeof r ? E(r) : r });
                        b = n;
                        d[b] || (d[b] = []);
                        d[b].push(c)
                    }
            ...
            check: function(a, b, c) {
                ...
                if ("string" == typeof a) {
                    ...
                    h = d
                } else d = a.getDefinition(), h = d.styles, m = d.attributes || {}, h && !CKEDITOR.tools.isEmpty(h) ? (h = H(h), m.style = CKEDITOR.tools.writeCssText(h, !0)) : h = {}, h = { name: d.element, attributes: m, classes: m["class"] ? m["class"].split(/\s+/) : [], styles: h, children: [] };
        ...
        return {
            load: function(b, c, e, g) {
                ...
                var k = b.length,
                    q = [],
                    w = [],
                    f = function(a) { c && (l ? c.call(e, a) : c.call(e, q, w)) };
                if (0 === k) f(!0);
                else {
                    var y = function(a, b) {
                            (b ? q : w).push(a);
    ...
    (function() {
        ...
        function d() { do var a = "editor" + ++t; while (CKEDITOR.instances[a]);
            return a }
        ...
        function q(a) { CKEDITOR.skin.loadPart("editor", function() { w(a) }) }
        ...
        function y(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                for (var f in c) {
                    ...
                    if (k && (v = k.match(n)))
                        for (; k = v.pop();) CKEDITOR.error("editor-plugin-required", { plugin: k.replace(",", ""), requiredBy: f });
    ...
    (function() {
            ...
            return a.replace(E,
                function(a, b, c) {
                    return "\x3c" + b + c.replace(C, function(a, b) {
                        return H.test(b) && -1 == c.indexOf("data-cke-saved-" + b) ? " data-cke-saved-" + a + " data-cke-" + CKEDITOR.rnd + "-" + a : a }) + "\x3e" })
        }

        function f(a, b) {
            return a.replace(b, function(a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + t(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e");
        ...
        var x = /(?:&nbsp;|\xa0)$/,
            ...
            h = CKEDITOR.tools.extend({}, u.$blockLimit,
                u.$block),
            n = { elements: { input: k, textarea: k } },
            m = { attributeNames: [
                    [/^on/, "data-cke-pa-on"],
                    [/^data-cke-expando$/, ""]
                ] },
            z = { elements: { embed: function(a) {
                        var b = a.parent;
                        if (b && "object" == b.name) {
        ...
        CKEDITOR.editor.prototype.setMode = function(a, b) {
            ...
            if (a != d.mode && l && l[a]) {
                ...
                if (d.mode) {
                    ...
                    d._.previousModeData = q = d.getData(1); "source" == d.mode && l == q && (d.fire("lockSnapshot", { forceUpdate: !0 }), w = 1);
            ...
            proto: {
                ...
                insertElement: function(a, b) {
                    ...
                    this.insertElementIntoRange(a, b) && (b.moveToPosition(a, CKEDITOR.POSITION_AFTER_END), f && ((f = a.getNext(function(a) {
                        return c(a) && !t(a) })) && f.type == CKEDITOR.NODE_ELEMENT && f.is(CKEDITOR.dtd.$block) ? f.getDtd()["#"] ? b.moveToElementEditStart(f) : b.moveToElementEditEnd(a) : f || e == CKEDITOR.ENTER_BR || (f = b.fixBlock(!0,
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    b.deleteContents(1);
                    b.startContainer.type == CKEDITOR.NODE_ELEMENT && b.startContainer.is({ tr: 1, table: 1, tbody: 1, thead: 1, tfoot: 1 }) && x(b);
                    var g, l;
                    if (f)
                        for (;
        ...
        p = function() {
            ...
            function b(c, d) {
                ...
                for (var l = C[l.getName()], z = 0, k = c.getChildren(), E = k.count(), B = -1, p = -1, q = 0, w = e.contains(C.$list); z < E; ++z) e = k.getItem(z), a(e) ? (m = e.getName(), w && m in CKEDITOR.dtd.$list ? g = g.concat(b(e, d)) : (n = !!l[m], "br" != m || !e.data("cke-eol") || z && z != E - 1 || (q = (f = z ? g[z - 1].node : k.getItem(z + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && C.$block[f.getName()]), -1 != B || n || (B = z), n || (p = z), g.push({
                    ...
                    name: m,
                    allowed: n
                }), f = q = 0)) : g.push({ isElement: 0, node: e, allowed: 1 }); - 1 < B && (g[B].firstNotAllowed = 1); - 1 < p && (g[p].lastNotAllowed = 1);
                return g
            }
            ...
            var C = CKEDITOR.dtd,
                p = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1 },
            ...
            return function(p, v, I, J) {
                ...
                if (!J.checkReadOnly()) {
                    ...
                    if (H = I) {
                        H = p.range;
                        if ("text" == p.type && p.inlineStylesRoot) { t = p.inlineStylesPeak;
                        ...
                        if ((A = H.startPath().block) && (1 != A.getChildCount() || !A.getBogus())) a: {
                            var y;
                            if (1 == t.getChildCount() && a(y = t.getFirst()) && y.is(q) && !y.hasAttribute("contenteditable")) { A = y.getElementsByTag("*");
                                H = 0;
                                for (J = A.count(); H < J; H++)
                    ...
                    if (H) {
                        ...
                        for (E(v, y); J < v.length; J++) {
                            ...
                            if (u = K.isLineBreak) {
                                ...
                                var S = void 0,
                                    aa = void 0;
                                K.hasBlockSibling ? u = 1 : (S = u.startContainer.getAscendant(C.$block, 1)) && S.is({ div: 1, p: 1 }) ? (aa = S.getPosition(P), aa == CKEDITOR.POSITION_IDENTICAL ||
                    ...
                    if (!p.dontMoveCaret) {
                        for (M = e(D); M && a(M) && !M.is(C.$empty);) {
                            if (M.isBlockBoundary()) D.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END);
                                ...
                                if (f(M) && M.getHtml().match(/(\s|&nbsp;)$/g)) { O = null;
                                    break }
                                O = D.clone();
            ...
            tree: {
                rebuild: function(a, b) {
                    ...
                    if (e.blockLimit.is({ tr: 1, table: 1 })) {
                        ...
                        g = function(a) {
                            return !a.equals(l) } } else if (e.block && e.block.is(CKEDITOR.dtd.$listItem) && (f = f.contains(CKEDITOR.dtd.$list), c = c.contains(CKEDITOR.dtd.$list), !f.equals(c))) {
    ...
    (function() {
        ...
        CKEDITOR.on("instanceCreated", function(b) {
            ...
            e.on("contentDom", function() {
                function b() { I = new CKEDITOR.dom.selection(e.getSelection());
                    I.lock() }
                ...
                if (CKEDITOR.env.ie || q) p ? g.attachListener(g, "beforedeactivate", b, null, null, -1) : g.attachListener(e, "selectionCheck", b, null, null, -1), g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function() { e.lockSelection(I);
                ...
                if (CKEDITOR.env.ie && !q) {
                    var J;
                    g.attachListener(g, "mousedown", function(a) { 2 == a.data.$.button && ((a = e.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (J = e.window.getScrollPosition())) });
                    g.attachListener(g, "mouseup", function(a) { 2 == a.data.$.button && J && (e.document.$.documentElement.scrollLeft = J.x, e.document.$.documentElement.scrollTop = J.y);
                        J = null });
                ...
                if (q && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
                    var F;
                    g.attachListener(g, "mousedown", function() { F = 1 });
        ...
        var G = { img: 1, hr: 1, li: 1, table: 1, tr: 1, td: 1, th: 1, embed: 1, object: 1, ol: 1, ul: 1, a: 1, input: 1, form: 1, select: 1, textarea: 1, button: 1, fieldset: 1, thead: 1, tfoot: 1 },
            ...
            r = new RegExp(u + "( )?", "g");
        CKEDITOR.tools.extend(CKEDITOR.dom.selection, { _removeFillingCharSequenceString: k, _createFillingCharSequenceNode: g, FILLING_CHAR_SEQUENCE: u });
            ...
            getRanges: function() {
                var a = p ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        for (; 0 < g;) try { h = f[0 < m ? "previousSibling" : "nextSibling"], h.nodeType == CKEDITOR.NODE_TEXT && (g -= h.nodeValue.length, p = h), f = h } catch (q) {
                        ...
                        if (k) this.fake(k);
                            ...
                            if (p) {
                                ...
                                for (r = 0; r < a.length; r++) {
                                    if (r < a.length - 1 && (t = a[r], u = a[r + 1], q = t.clone(), q.setStart(t.endContainer, t.endOffset), q.setEnd(u.startContainer, u.startOffset), !q.collapsed && (q.shrink(CKEDITOR.NODE_ELEMENT, !0), k = q.getCommonAncestor(), q = q.getEnclosedNode(), k.isReadOnly() || q && q.isReadOnly()))) { u.setStart(t.startContainer, t.startOffset);
                                        a.splice(r--, 1);
                                        continue }
                                    k = a[r];
                                    ...
                                    try { u.setEnd(k.endContainer.$, k.endOffset) } catch (I) {
    ...
    (function() {
            ...
            if (c.collapsed) f = G(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END);
                ...
                for (t.getPosition(w) == CKEDITOR.POSITION_FOLLOWING && (t = 0); t;) {
                    ...
                    if (t.equals(w)) t = null, k = !0;
                        ...
                        if (y && t.data("cke-bookmark")) { t = t.getNextSourceNode(!0);
                            continue }
        ...
        CKEDITOR.style.prototype = {
            ...
            removeFromRange: function(a) { this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ? q : this.type == CKEDITOR.STYLE_OBJECT ? l : null;
            ...
            do
                if (q.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (!l && (w = q.getName(),
                        ...
                        if (w = !g && "div" == w) { a: { w = q.getChildren();
    ...
    */
    ...
    CKEDITOR.config.font_names = "新細明體;標楷體;微軟正黑體;Arial/Arial, Helvetica, sans-serif;Comic Sans MS/Comic Sans MS, cursive;Courier New/Courier New, Courier, monospace;Georgia/Georgia, serif;Lucida Sans Unicode/Lucida Sans Unicode, Lucida Grande, sans-serif;Tahoma/Tahoma, Geneva, sans-serif;Times New Roman/Times New Roman, Times, serif;Trebuchet MS/Trebuchet MS, Helvetica, sans-serif;Verdana/Verdana, Geneva, sans-serif";
    ...
    CKEDITOR.lang.languages = { "zh": 1, "en": 1 };
}());
